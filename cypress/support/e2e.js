...
Cypress.Commands.add('selectByTestID', (value) => {
  return cy.get(`[data-testid="${value}"]`);
});

Cypress.Commands.add('selectByPartialBeginTestID', (selector, ...args) => {
  return cy.get(`[data-testid^="${selector}"]`, ...args);
});

Cypress.Commands.add('selectByPartialEndTestID', (selector, ...args) => {
  return cy.get(`[data-testid$="${selector}"]`, ...args);
});

Cypress.Commands.add('selectByPartialMidTestID', (selector, ...args) => {
  return cy.get(`[data-testid*="${selector}"]`, ...args);
});
